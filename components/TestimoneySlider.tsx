...
export default function TestimoneySlider() {
  return (
      ...
      <div className="mb-8 sm:break-inside-avoid">
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex justify-center gap-0.5 text-blue-800">
                <svg
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-900">Samuel Stanley</p>
            </div>
          </div>
        ...
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-900">PSamuel Stanley</p>
            </div>
          </div>
