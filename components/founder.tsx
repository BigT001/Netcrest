...
export default function Founder() {
  return (
    ...
    <div className='container rounded-xl flex-col lg:mt-16 pt-16 w-auto items-center 
       shadow-md border-r-black border-2 border-l-black shadow-blue-400'>
        <div className='text-center '>
            ...
            <h4 className='text-gray-700 text-lg mt-2'>
              ...
              catalyzed by the global pandemic. This shift has unlocked unprecedented 
              opportunities, paving the way for a surge in digital innovation. 
              With the world increasingly turning to the internet for solutions, 
              the possibilities are limitless. Getting your idea started and scaling is the reason
              why Netcrests is here. Don't sleep on your idea.
            </h4>
