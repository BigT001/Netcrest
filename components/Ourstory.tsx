...
export default function Ourstory() {
  return (    
        <div className='grid grid-cols-1 lg:grid-cols-2 border-2 shadow-xl 
        shadow-blue-300 border-gray-300 pt-16 mt-20 mr-10 ml-10 
        lg:mr-20 lg:ml-20 sm:pb-5 lg:gap-x-0 rounded-xl'>            
           <div className='grid gap-5 text-md pr-5 pl-5 shadow-md rounded-xl shadow-blue-400'> 

                <div className='text-center text-white'>
                  <h1 className='text-3xl text-black font-bold '>
                    Our {" "}
                    <span className='bg-blue-800 text-white px-2'>
                    Story
                    </span>
                  </h1>
                </div>
                ...
                <div>
                  ...
                  unique needs of each client. Founded by Samuel Stanley, Netcrest has grown 
                  from a small startup into a trusted partner for businesses looking to make a 
