...
const slugs = [
  "typescript", "javascript", "java", "react", "flutter", "html5", "css3",
  "nodedotjs",
  "nextdotjs",
  "prisma",
  "amazonaws",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">      
          <div className=" flex items-center b">
            <div className="p-8 sm:p-16">
              <CardContent className="border-l border-b rounded-xl 
                ...
                <p className='text-xl  '>
                  ...
                  <p className="mt-4 text-gray-600">
                    ...
                    By leveraging modern frameworks and libraries, 
                    we build robust, secure, and efficient solutions.
                  </p>
